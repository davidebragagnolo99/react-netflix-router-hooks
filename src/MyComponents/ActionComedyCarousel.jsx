...
class ActionComedyCarousel extends Component {
  ...
  async componentDidMount() {
    try {
      const response = await fetch("http://www.omdbapi.com/?i=tt3896198&apikey=ec91d2e&s=john-wick");
      if (response.ok) {
    ...
    try {
      const response = await fetch("http://www.omdbapi.com/?i=tt3896198&apikey=ec91d2e&s=batman");
      if (response.ok) {
        const data = await response.json();
