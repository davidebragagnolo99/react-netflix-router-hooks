...
class FantasyCarousel extends Component {
  ...
  async componentDidMount() {
    try {
      const response = await fetch("http://www.omdbapi.com/?i=tt3896198&apikey=ec91d2e&s=star-wars");
      if (response.ok) {
    ...
    try {
      const response = await fetch("http://www.omdbapi.com/?i=tt3896198&apikey=ec91d2e&s=harry-potter");
      if (response.ok) {
        const data = await response.json();
    ...
    try {
      const response = await fetch("http://www.omdbapi.com/?i=tt3896198&apikey=ec91d2e&s=lord-of-the-rings");
      if (response.ok) {
        const data = await response.json();
  ...
  render() {
    return (
      <>
        <h5 className="text-light ms-5 mt-4">Fantasy/Scifi</h5>
